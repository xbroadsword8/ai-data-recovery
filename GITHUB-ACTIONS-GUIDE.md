...
1. 訪問 GitHub Release 頁面
   ↓
2. 下載最新版本的 AI Data Recovery.exe
   ↓
3. 雙擊運行，無需安裝 Python
   ↓
...
│  ┌──────────────────────────────────────────────────────────────────┐   │
│  │                    4. 構建 .exe                                 │   │
│  │  pyinstaller --onefile --windowed --name "AI Data Recovery"     │   │
│  └──────────────────────────────────────────────────────────────────┘   │
│                                          │                               │
│                                          ▼                               │
│  ┌──────────────────────────────────────────────────────────────────┐   │
...
git init
git add .
git commit -m "Initial commit: AI Data Recovery"
git remote add origin https://github.com/username/ai-data-recovery.git
...
```
1. 訪問 https://github.com/username/ai-data-recovery/actions
2. 查看最近的 Workflow 執行
3. 等待 build job 完成
4. 下載生成的 .exe 文件
```
...
```
1. 訪問 https://github.com/username/ai-data-recovery/releases
2. 下載最新版本的 AI Data Recovery.exe
3. 雙擊運行
```
...
1. **創建 GitHub Repository**
   ```bash
   gh repo create ai-data-recovery --public --source=. --remote=origin
   ```
